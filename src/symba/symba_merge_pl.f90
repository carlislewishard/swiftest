...
! Executable code
     ...
     IF (lmerge) THEN
          ...
          array_keep_child(1:NCHILDMAX) = symba_plA%index_child(1:NCHILDMAX,index1_parent)
          ...
          array_rm_child(1:NCHILDMAX) = symba_plA%index_child(1:NCHILDMAX,index2_parent)
